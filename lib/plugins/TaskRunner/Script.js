...
module.exports = class Script extends require('./AbstractPlugin') {
  ...
  constructor(container, options) {
    ...
    var self = this
    this.on("running", function(running){
      console.log("script task is running")
      self.runScript()
    })
  }
  ...
  runScript(){
    this.createScriptStream(this.running.stream).end(this.script)
  }
